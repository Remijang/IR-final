...
def init_new_toc():
    ...
    df = pd.read_csv(toc_path, dtype={"Chapter": str, "Section": str, "Page": int})
    content_list_idx = 0
    ...
    for index, row in df.iterrows():
        ...
        while True:
            ...
            try:
                ...
                print(type(chapter), type(section))
                print(chapter)
                print(section)
                assert False
            # if chapter_name[0] == "I":
