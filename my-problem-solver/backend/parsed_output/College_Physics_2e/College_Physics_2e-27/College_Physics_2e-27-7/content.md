...
The next thickness that gives constructive interference is $t _ { \textrm { c } } ^ { \prime } = 3 \lambda _ { n } / 4$ , so that
...
Step 6.Solvetheap ropriateequationforthequantitytobedetermined(theunknown),andentertheknowns.   
